...
function createVis() {
    ...
    var EventHandler = {};
    electoralMap = new OldElectoralMap("#ElectoralMap",dataCSV,EventHandler);
    ...
    white = new OldPerson("#white-picture",1.034, 151141962,"White");
    black = new OldPerson("#black-picture",1.004, 29732845,"Black");
    hispanic = new OldPerson("#hisp-picture",.92, 44599268,"Hispanic");
    asian = new OldPerson("#asian-picture",.88, 14866423,"Asian");
}
